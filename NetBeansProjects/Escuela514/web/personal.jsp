...
<form class="row g-3">
 ...
 <form class="row g-3">
        <div class="col-auto">
        <label for="staticEmail2" class="visually-hidden">Area</label>
        <input type="text" readonly class="form-control-plaintext" id="staticEmail2" value="Area">
        </div>
        <div class="col-auto">
        <label for="inputPassword2" class="visually-hidden">Area</label>
        <input type="password" class="form-control" id="inputPassword2" placeholder="Area">
        </div>
</form>    
<form class="row g-3">
        <div class="col-auto">
...
<form class="row g-3">
        <div class="col-auto">
        <label for="staticEmail2" class="visually-hidden">Otras Obs</label>
        <input type="text" readonly class="form-control-plaintext" id="staticEmail2" value="Otras Obs">
        </div>
        <div class="col-auto">
        <label for="inputPassword2" class="visually-hidden">Otras Obs</label>
        <input type="password" class="form-control" id="inputPassword2" placeholder="Otras Obs">
        </div>
</form> 
</form>  
        </div>
